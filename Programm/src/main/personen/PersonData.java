...
public class PersonData {
    ...
    public void setup(Function function, History history, ZeitArbeiter zeitArbeiter, Arbeiter arbeiter, Manager manager, Geschaeftsfuehrer geschaeftsfuehrer, int changedLevel) {
    ...
    public boolean dataPresent(Function function, History history) {
        if (isUseDataPresent()) {
            ...
            setup(function, history,zeitArbeiter1, null,null,null,1);
            ...
            setup(function, history,null,null,manager1,null,1);
            ...
            setup(function, history,null,null,manager2,null,1);
